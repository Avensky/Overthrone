                    ...
                    <div className={myClasses.Cart} key={item._id}>
                        ...
                        <div className={myClasses.Item}>
                            ...
                            <div className={myClasses.Remove}>
                                <i className={[
                                  'material-icons',
                                  myClasses.MaterialIcons,
                                  classes.noselect].join(' ')}
      ...
      <div className={[classes.Card, myClasses.Shop].join(' ')}>
        <div className={myClasses.Cart}>
          ...
          <div className={myClasses.Collection}>
            {addedItems}
            {props.totalPrice ? <h3>Subtotal = ${props.totalPrice}</h3> : null}
            {props.totalItems > 0
              ? (<button className='btn-primary btn' type="button" role="link"onClick={purchaseHandler}>{
                props.isAuth !== null ? 'CONTINUE TO CHECKOUT' : 'SIGN IN TO ORDER'}</button>)
              : null
            }
          </div>
        </div>
