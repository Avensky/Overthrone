        ...
        <Formik
          ...
          render = { (formik) => <Form>
            ...
            <Field
              type="text"
              name="address"
              // placeholder={user.addresses.address1 ? user.addresses.address1:
            ...
            <Field
              type="text"
              name="address2"
              // placeholder={user.addresses.address2 ? user.addresses.address2:
            ...
            <div className="flex">
              ...
              <div className='margin-side'>
                ...
                <Field
                  ...
                  // ? user.addresses.state : user.addresses.state}
                  className={myClasses.ContactDataInput}
                >
