    ...
    return(
        <div className={[classes.Card, myClasses.Authors].join(' ')}>
            ...
            <Author                     
                ...
                After entering the film industry in England as a special effects make-up artist on major 
