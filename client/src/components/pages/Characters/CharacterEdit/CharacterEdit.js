...
//         const author =  props.payload.username;
        props.onUpdateChar(
            characterForm.name.value, 
            characterForm.age.value, 
            characterForm.relatives.value, 
            characterForm.bio.value
        );
    };
...
//                valid: checkValidity( event.target.value, characterForm[controlName].validation ),
                touched: true
            },
            date: {
                ...characterForm.date,
