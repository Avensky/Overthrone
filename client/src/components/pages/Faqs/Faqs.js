    ...
    <div className={myClasses.Headlines}>
      <div className={myClasses.Faq}>
        <div className={classes.CardTitle}>
          Is S.J.Evans related by any chance to Mary Anne Evans,
          whose pen name was George Elliot?
        </div>
      ...
      <div className={myClasses.Faq}>
        ...
        <p>
          We have purposefully created names that are short and relatively easy
          to pronounce. We have tried to derive them from a variety of nationalities.
        </p>
        <ul>
          <li>Agni: Ag-knee    </li>
      ...
      <div className={myClasses.Faq}>
        ...
        <ul>
          ...
          <li>
            Shows with strong yet flawed female roles such as Doctor
            Foster and Apple Tree Yard
          </li>
        </ul>
        <h5><b>J.M. Prigot:</b></h5>
        <ul>
      ...
      <div className={myClasses.Faq}>
        ...
        <ul>
          ...
          <li>
            Movies directed by Stanley Kubrick, early Polanski,
            the Coen brothers, and Christopher Nolan\
          </li>
        </ul>
        <h5><b>J.M. Prigot:</b></h5>
        <ul>
      ...
      <div className={myClasses.Faq}>
        <div className={classes.CardTitle}>
          I want to make a Halloween costume/piece of jewelry/etc.
          based on one of your characters. Do I have to get your permission?
        </div>
          <p>
            Not if the costume/piece of jewelry/etc. is just for your personal
            enjoyment and use. However, if you want to sell costumes or jewelry,
            etc.  and make profit from our books in some way, then you would need
            to try and secure some sort of agreement from S.J.Evans in writing.
          </p>
        </div>
        <div className={myClasses.Faq}>
