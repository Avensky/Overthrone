...
const newItemStart = (state, action) => updateObject(state, {
  posted: false,
});

const newItemFail = (state, action) => updateObject(state, {
  loading: false,
});
...
const getItemByIdStart = (state, action) => updateObject(state, {
  loading: true,
});

const getItemByIdFail = (state, action) => updateObject(state, {
  loading: false,
});

const getItemByIdSuccess = (state, action) => updateObject(state, {
  itemById: action.itemById,
  loading: false,
});

const deleteItemStart = (state, action) => updateObject(state, {
  loading: true,
});

const deleteItemFail = (state, action) => updateObject(state, {
  loading: false,
});

const deleteItemSuccess = (state, action) => updateObject(state, {
  loading: false,
});
